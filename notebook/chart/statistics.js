...
export function boxSummary(values, whisker = 1.5) {
...
export function kde(values, bandwidth = null, resolution = 80) {
...
export function correlationMatrix(rows, columns, method = 'pearson') {
...
export function makeHexbins(points, bins = 30) {
