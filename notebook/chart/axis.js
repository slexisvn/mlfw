import { svgElement, svgText, formatTick } from './svg.js';

export function renderAxes(root, layout, xScale, yScale, labels) {
  ...
  if (labels.x) axes.append(svgText(labels.x, { class: 'chart-axis-label', x: (layout.left + layout.right) / 2, y: layout.height - 8, 'text-anchor': 'middle' }));
