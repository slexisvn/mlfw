...
- **Per-pass verification**, which turns Chapter 12's invariants into an attribution mechanism and is the foundation of Chapter 67's debugging procedure.
