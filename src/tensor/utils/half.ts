...
export function coerceForStorage(dtype: string, v: number | bigint): number | bigint {
  if (dtype === 'f16') return f32ToF16(Number(v));
  if (dtype === 'bf16') return f32ToBf16(Number(v));
...
const _g = globalThis as typeof globalThis & {
  __mlfw_f16_to_f32: typeof f16ToF32;
  __mlfw_f32_to_f16: typeof f32ToF16;
  __mlfw_bf16_to_f32: typeof bf16ToF32;
  __mlfw_f32_to_bf16: typeof f32ToBf16;
};
