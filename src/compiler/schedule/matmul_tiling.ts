...
import type { BlockClassification } from './rules.js';
...
export function enumerateRegisterBlockConfigs(target: ScheduleTarget, dims: MatmulTileDims | { M: number; N: number; K: number }, maxCandidates = 32): RegisterBlockConfig[] {
