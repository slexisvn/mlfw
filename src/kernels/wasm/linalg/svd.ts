...
function gramSym(mat: Float64Array, m: number, len: number): Float64Array {
...
function wasmGram(a: Float64Array, rows: number, cols: number, transposeLeft: boolean): Float64Array {
  if (transposeLeft) {
...
function wasmMatmulRows(a: Float64Array, m: number, len: number, b: Float64Array, p: number): Float64Array {
...
export function wasmSvd(_keySet: unknown, a: Tensor): Tensor[] {
