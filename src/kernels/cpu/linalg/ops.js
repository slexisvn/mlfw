...
export function cpuLstsq(_keySet, a, b) {
...
export function cpuInv(_keySet, a) {
...
export function cpuSvd(_keySet, a) {
  const { data, rows, cols } = hostMatrix(a);
