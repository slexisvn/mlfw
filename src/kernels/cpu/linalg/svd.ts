...
export type SvdResult = { U: Float64Array; S: Float64Array; V: Float64Array; k: number };
export type GramFn = (a: Float64Array, rows: number, cols: number, transposeLeft: boolean) => Float64Array;
export type MatmulRowsFn = (a: Float64Array, m: number, len: number, b: Float64Array, p: number) => Float64Array;

export function gram(a: Float64Array, rows: number, cols: number, transposeLeft: boolean): Float64Array {
  if (transposeLeft) {
...
export function matmulRows(a: Float64Array, m: number, len: number, b: Float64Array, p: number): Float64Array {
...
export function svdHost(a: Float64Array, rows: number, cols: number, opts?: LinalgOpts, gramFn: GramFn = gram, matmulFn: MatmulRowsFn = matmulRows): SvdResult {
