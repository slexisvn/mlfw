...
export function topKSelect(dist: Float64Array, idx: Int32Array, ntr: number, k: number): void {
...
export function knnVote(y: Float64Array, idx: Int32Array, k: number, classify: boolean): number {
  if (classify) {
...
export function cpuKnnPredict(_keySet: unknown, XTrain: Tensor, yTrain: Tensor, XQuery: Tensor, nNeighbors: number, classify: boolean): Tensor {
